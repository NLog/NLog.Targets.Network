...
Primarily for applications that already use NLog, and want to send NLog log events directly in OTLP protobuf format without depending on the OpenTelemetry SDK pipeline.
